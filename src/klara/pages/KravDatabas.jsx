  ...
  modules: [
    ...
    },
    {
      ...
      requirements: [
        ...
        { id: "M02-R03", prio: "Hög", status: "Byggt", req: "Aktivitetsstickers — klickbara ikoner direkt i kalendervyn", type: "Feature" },
        { id: "M02-R04", prio: "Hög", status: "Byggt", req: "Fördefinierade aktivitetstyper: dans, simning, kalas, läkare, paddling, gympakläder m.fl.", type: "Feature" },
        { id: "M02-R05", prio: "Hög", status: "Byggt", req: "Återkommande stickers per aktivitetstyp", type: "Feature" },
        { id: "M02-R06", prio: "Hög", status: "Byggt", req: "Drag-och-släpp av stickers på dagar", type: "Feature" },
        { id: "M02-R07", prio: "Hög", status: "Planerad", req: "Google Calendar API-integration (båda vuxna)", type: "Integration" },
        { id: "M02-R08", prio: "Hög", status: "Byggt", req: "Konfliktdetektering — båda vuxna borta samtidigt → barnvakt-larm", type: "Feature" },
        { id: "M02-R09", prio: "Med", status: "Byggt", req: "Klassificering av events: resa, fest, jobb, barnaktivitet", type: "Feature" },
    ...
    },
    {
      ...
      requirements: [
        ...
        { id: "M03-R04", prio: "Hög", status: "Byggt", req: "Buggfixar: dra-och-släpp, statusuppdateringar, persontilldelning", type: "Bugg" },
        { id: "M03-R05", prio: "Med", status: "Byggt", req: "Tidsestimering per task (30 min, 2h, halvdag)", type: "Feature" },
        { id: "M03-R06", prio: "Med", status: "Byggt", req: "Subtasks — undertasks som bockas av en i taget", type: "Feature" },
        { id: "M03-R07", prio: "Med", status: "Byggt", req: "Prioritetsnivåer per task", type: "Feature" },
        { id: "M03-R08", prio: "Med", status: "Byggt", req: "Deadline-datum per task", type: "Feature" },
    ...
    },
    {
      ...
      requirements: [
        { id: "M04-R01", prio: "Med", status: "Byggt", req: "Lägg till medicin per familjemedlem", type: "Feature" },
        { id: "M04-R02", prio: "Med", status: "Byggt", req: "Fält: namn, form (tablett/mixtur/suppositorium), antal kvar, daglig dos", type: "Feature" },
        { id: "M04-R03", prio: "Med", status: "Byggt", req: "Beräkning: 'räcker till'-datum baserat på dos × antal kvar", type: "Feature" },
        { id: "M04-R04", prio: "Med", status: "Byggt", req: "Beställningströskel — påminnelse när X dagar kvar", type: "Feature" },
        { id: "M04-R05", prio: "Med", status: "Byggt", req: "Statusindikator per medicin: grön/gul/röd", type: "UI" },
        { id: "M04-R06", prio: "Hög", status: "Byggt", req: "Doslogg med tidsstämpel — 'senast given: idag 14:32'", type: "Feature" },
        { id: "M04-R07", prio: "Hög", status: "Byggt", req: "Dosrekommendation i ml baserat på barnets ålder (Alvedon, Ipren m.fl.)", type: "Feature" },
        { id: "M04-R08", prio: "Med", status: "Byggt", req: "Direktlänk till FASS per läkemedel", type: "Integration" },
        { id: "M04-R09", prio: "Hög", status: "Byggt", req: "Gästläge döljer all medicininfo", type: "Feature" },
    ...
    },
    {
      ...
      requirements: [
        { id: "M05-R01", prio: "Med", status: "Byggt", req: "Ny flik: Hus-underhåll", type: "Feature" },
        { id: "M05-R02", prio: "Med", status: "Byggt", req: "Kategorier: utvändigt, inomhus, teknik, trädgård", type: "Feature" },
        { id: "M05-R03", prio: "Med", status: "Byggt", req: "Per uppgift: intervall (varje år, vart 5:e år) + senast utfört-datum", type: "Feature" },
        { id: "M05-R04", prio: "Med", status: "Byggt", req: "Filter: förfallet, kommande 3 månader", type: "Feature" },
        { id: "M05-R05", prio: "Låg", status: "Framtid", req: "Delar datamodell med Kanban/Epics", type: "Teknisk" },
        { id: "M05-R06", prio: "Med", status: "Byggt", req: "Garantiuppföljning per produkt/installation", type: "Feature" },
      ]
    },
    {
      id: "M06", name: "Bil-påminnelser", icon: "🚗", color: "#7CA8E8",
      requirements: [
        { id: "M06-R01", prio: "Med", status: "Byggt", req: "Återkommande årsreminders per bil", type: "Feature" },
        { id: "M06-R02", prio: "Med", status: "Byggt", req: "Typer: däckbyte vår, däckbyte höst, besiktning, service, städning", type: "Feature" },
        { id: "M06-R03", prio: "Med", status: "Byggt", req: "Påminnelse dyker upp i dagsvyn när datum närmar sig", type: "Feature" },
        { id: "M06-R04", prio: "Med", status: "Byggt", req: "Stöd för flera bilar i familjen", type: "Feature" },
    ...
    },
    {
      ...
      requirements: [
        { id: "M07-R01", prio: "Med", status: "Byggt", req: "Ny flik: Ekonomi", type: "Feature" },
        { id: "M07-R02", prio: "Med", status: "Byggt", req: "Budget-översikt (manuell inmatning initialt)", type: "Feature" },
        { id: "M07-R03", prio: "Med", status: "Byggt", req: "Ekonomisk kalender: deklaration, försäkringsförnyelser, semesterkassa", type: "Feature" },
        { id: "M07-R04", prio: "Med", status: "Byggt", req: "Spartips-sektion", type: "Feature" },
        { id: "M07-R05", prio: "Med", status: "Planerad", req: "Diagram via Recharts", type: "UI" },
        { id: "M07-R06", prio: "Hög", status: "Byggt", req: "Gästläge döljer ALL ekonomiinfo", type: "Feature" },
        { id: "M07-R07", prio: "Låg", status: "Framtid", req: "Bank-API-integration", type: "Integration" },
        { id: "M07-R08", prio: "Med", status: "Byggt", req: "Månadsrapport ekonomi", type: "Feature" },
      ]
    },
    {
